...
export const clusterSymmetryAnnotationAlgorithm: AnnotationAlgorithm = {
  ...
  annotate(keys: ReadonlyArray<Key>): AnnotationResult {
    ...
    if (base.status !== 'success') {
      return {
        ...base,
        meta: { ...(base.meta ?? {}), symmetry: 'fallback', symmetryFallbackReason: 'base-not-success' },
      }
    }
    ...
    if (regulars.length === 0) {
      return {
        ...base,
        meta: { ...(base.meta ?? {}), symmetry: 'fallback', symmetryFallbackReason: 'no-regular-keys' },
      }
    }
    ...
    if (!info) {
      ...
      return {
        ...base,
        warnings,
        meta: { ...(base.meta ?? {}), symmetry: 'fallback', symmetryFallbackReason: 'unpaired-key' },
      }
    }
    ...
    if (!enforced) {
      ...
      return {
        ...base,
        warnings,
        meta: { ...(base.meta ?? {}), symmetry: 'fallback', symmetryFallbackReason: 'center-conflict' },
      }
    }
