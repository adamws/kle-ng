...
handles at once. The field beside the slider takes the same value as a number, for a curvature you
can land on exactly and write down; drag a handle and it reads the curve back, so the two controls
always agree. The layout updates live.
...
| Control                   | Description                                                                                                                                                           |
| ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Bend**                  | Moves both shaping handles together, as a percentage of the block's own length, for symmetric curves without dragging handles. Type into the field for an exact value |
